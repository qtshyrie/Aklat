...
public class StaffJframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Student, Login here.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String staffpass = jPasswordField1.getText().trim();

    try {
        String sql = "SELECT * FROM staffaccounts WHERE StaffID = ? AND Password = ?";
        java.sql.PreparedStatement pst = Db.conn.prepareStatement(sql);
        pst.setString(1, staffid);
        pst.setString(2, staffpass);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new StaffJframe().setVisible(true));
    }
