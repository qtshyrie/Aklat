...
public class StudentJframe extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(StaffJframe.class.getName());
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(250, 129, 40));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Student Login", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Sylfaen", 1, 18))); // NOI18N
    ...
    public static String loggedStudentID;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String studentemail = jTextField2.getText().trim();
        String studentpass = jPasswordField1.getText().trim();

    try {
        String sql = "SELECT * FROM studentaccounts WHERE StudentID = ? AND email = ? AND password = ?";
        java.sql.PreparedStatement pst = Db.conn.prepareStatement(sql);
        pst.setString(1, studentid);
        pst.setString(2, studentemail);
        pst.setString(3, studentpass);
        java.sql.ResultSet rs = pst.executeQuery();
        
        
        
        if (rs.next()) {
            loggedFirstName = rs.getString("firstname");
            loggedLastName = rs.getString("lastname");
